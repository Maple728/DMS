...
(function() {
angular.module("dashboardApp").directive("demoTrackedTable", demoTrackedTable);
...
(function() {
angular.module("dashboardApp").directive("demoTrackedTableRow", demoTrackedTableRow);
...
(function() {
angular.module("dashboardApp").directive("demoTrackedTableCell", demoTrackedTableCell);
